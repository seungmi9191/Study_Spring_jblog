...
public class CateVo {
	...
	public CateVo(String id, String cateName, String description, String regDate) {
		this.id = id;
	...
	public CateVo(int cateNo, String id, String cateName, String description, int postNum) {
		this.cateNo = cateNo;
		this.id = id;
		this.cateName = cateName;
		this.description = description;
