	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				...
				<form action="${pageContext.request.contextPath}/${bVo.id}/admin/basic" method="POST" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		<tr>
			      			<td class="t">블로그 제목</td>
			      			<td><input type="text" size="40" name="blogTitle" value="${bVo.blogTitle}"></td>
			      		</tr>
			      		<tr>
			      			<td class="t">로고이미지</td>
